...
public class PacketHelperDialog extends BottomPopupView {
    ...
    public static EditText etSeq;
    public static EditText etTimestamp;
    ...
    protected void onCreate() {
        ...
        new Handler(Looper.getMainLooper()).postDelayed(() -> {
            ...
            etSeq = findViewById(R.id.seq);
            etTimestamp = findViewById(R.id.timestamp);
            ...
            etSeq.setVisibility(VISIBLE);
            etTimestamp.setVisibility(VISIBLE);
